"""
Django settings for sydneiblog project.
...
SECRET_KEY = 'django-insecure-sf%d4cf7id-4_ohhb(&cjrzu9w7%+vjh5u3$it0frudxu-_&18'
...
WSGI_APPLICATION = 'sydneiblog.wsgi.application'
